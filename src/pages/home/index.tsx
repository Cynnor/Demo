import { Button, Form, Image, Input, Modal, Popconfirm, Table, Upload, type GetProp, type UploadFile, type UploadProps } from "antd"
import "./index.scss"
...
// style 2
  const handleDelete = async (id) => {
    await axios.delete(`https://685aa8dc9f6ef9611157511f.mockapi.io/apidemo/${id}`);
